...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
	...
	if (!array_filter($error)) {
		...
		header("location: dashbord.php?wellcom");
	}
}
?>
<div class="container">
		...
		<form class="form-horizontal  " action=<?php echo $_SERVER["PHP_SELF"]; ?> method="post">
			...
			<div class="form-group form-group-lg">
				...
				<div class=" input_container">
					<input type="text" placeholder="<?php la("placeholder_name") ?>" class=form-control name=name required>
			...
			<div class="form-group form-group-lg">
				...
				<div class=" input_container">
					<input type="text" placeholder="<?php la("placeholder_email") ?> " class="form-control" name=email>
			...
			<div class="form-group form-group-lg">
				...
				<div class=" input_container">
					<input type="text" placeholder="<?php la("placeholder_number") ?>" class="form-control" name=number>
			...
			<div class="form-group form-group-lg">
				...
				<div class=" input_container">
					<input type="password" placeholder="<?php la("placeholder_pass") ?>" class="form-control" name=password1>
				</div>
			...
			<div class="form-group form-group-lg">
				...
				<div class=" input_container">
					<input type="password" placeholder="<?php la("passwoerd_agin") ?>" class="form-control" name=password2>
				</div>
				<h6 class="error"><?php echo $error["pass"] ?></h6>
			</div>
